...
<head>
  ...
  <title>Poolside Parties | Deep Faraskhana</title>
</head>
                  ...
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="../img/categories/poolside-parties/image-04.jpg"></div>
                      </div>
                    </div>
                    <a href="../img/categories/poolside-parties/image-04.jpg" class="portfolioCard__link"></a>
                  </div>
                </div>
              </div>
              ...
              <div class="masonry__item web_design">
                <div class="portfolioCard -type-2">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="../img/categories/poolside-parties/image-02.jpg"></div>
                      </div>
                    </div>
                    <a href="../img/categories/poolside-parties/image-02.jpg" class="portfolioCard__link"></a>
                  </div>
                </div>
              </div>
              ...
              <div class="masonry__item web_design">
                <div class="portfolioCard -type-2">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="../img/categories/poolside-parties/image-03.jpg"></div>
                      </div>
                    </div>
                    <a href="../img/categories/poolside-parties/image-03.jpg" class="portfolioCard__link"></a>
                  </div>
                </div>
              </div>
              ...
              <div class="masonry__item web_design">
                <div class="portfolioCard -type-2">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="../img/categories/poolside-parties/image-01.jpg"></div>
                      </div>
                    </div>
                    <a href="../img/categories/poolside-parties/image-01.jpg" class="portfolioCard__link"></a>
                  </div>
                </div>
              </div>
              ...
              <div class="masonry__item web_design">
                <div class="portfolioCard -type-2">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="../img/categories/poolside-parties/image-05.jpg"></div>
                      </div>
                    </div>
                    <a href="../img/categories/poolside-parties/image-05.jpg" class="portfolioCard__link"></a>
                  </div>
                </div>
              </div>
          <!-- container end -->
